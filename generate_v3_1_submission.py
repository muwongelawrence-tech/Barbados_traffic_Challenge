"""
Generate Submission with Tuned Model v3.1
Using best single model (F1: 0.5219)
"""
import sys
import os
...
print("="*60)
print("SUBMISSION v3.1 - TUNED LIGHTGBM")
print("="*60)
...
video_feature_cols = model_data['video_feature_cols']

print(f"✓ Loaded tuned model (F1: 0.5219)")
...
# Save
output_path = os.path.join(config.SUBMISSIONS_DIR, 'v3.1_tuned_final.csv')
...
print(f"Model: Tuned LightGBM v3.1")
print(f"Validation F1: 0.5219")
print(f"Expected leaderboard: 0.52-0.56")
print("="*60)
